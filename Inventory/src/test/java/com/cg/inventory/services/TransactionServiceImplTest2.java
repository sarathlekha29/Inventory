...
class TransactionServiceImplTest2 {
	...
	public void setUp() throws Exception {
		...
		order = new Order(LocalDate.now(), LocalDate.of(2021, 7, 30), 1200f, customer, products);
	}
	...
	public void testViewAllTransactions() {
		Transaction transaction = new Transaction(LocalDate.of(2022, 6, 30), 1500f, 100f, "cash", 1600f, 0f,
				order);
		Transaction transaction1 = new Transaction(LocalDate.of(2022, 6, 30), 1500f, 100f, "cash", 1600f, 0f,
				order);
		Transaction transaction2 = new Transaction(LocalDate.of(2022, 6, 30), 1500f, 100f, "cash", 1600f, 0f,
				order);
	...
	public void testUpdateTransaction() {
		...
		updatedTransaction.setTransactionDate(LocalDate.of(2021, 6, 30));
