...
class ProductControllerTest2 {
	...
	public void testAddProduct() throws Exception {
		...
		String URI = "/api/v1/product/createProduct";
	...
	public void testViewAllProducts() throws Exception {
		...
		String URI = "/api/v1/product/getAllProducts";
		Product product = new Product();
		product.setProductId(10L);
		product.setProductName("Redmi Mobile");
		product.setProductPrice(100F);
	...
	public void testViewProductById() throws Exception {
		String URI = "/api/v1/product/getProductById/{productId}";
		Product product = new Product();
		product.setProductId(10L);
		product.setProductName("Redmi Mobile");
		product.setProductPrice(100F);
	...
	public void testUpdateProduct() throws Exception {
		String URI = "/api/v1/product/updateProduct/{productId}";
		Category cc = new Category("Electronics", "This is a site for electronics ");
		cc.setCategoryId(1L);
		Product product = new Product();
		product.setProductId(10L);
	...
	public void testRemoveProduct() throws Exception {
		String URI = "/api/v1/product//deleteProduct/{productId}";
		Product prod = new Product();
